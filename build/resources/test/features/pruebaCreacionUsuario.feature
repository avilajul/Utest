...
Feature: User Creation, as a user I want to register in the uTest community
  ...
  Scenario Outline: register a user in the uTest community
    ...
    Examples:
      ...
      | Julian Eduardo | Avila Tascon | ludev@gmail.com | March | 26 | 1984 | Spanish | Santa Marta | 763022 | Motorola | Moto E7 Plus | Android 10 | Choucair2021* | Choucair2021* | Welcome to the world's largest community of freelance software testers! |
